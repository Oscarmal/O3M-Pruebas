...
<div id="pagina">
  ...
  <tr>
    ...
    <td></td>
	    ...
	    <div id="menu"><a href="/mahanaim.tlalpan/inicio.php" target="_self" class="link_menu">Inicio</a> | <a href="inventarios/index.php" target="cuadro" class="link_menu">Inventarios</a> | <a href="contabilidad/index.php" target="cuadro" class="link_menu">Contabilidad</a> | <a href="congregantes/index.php" target="cuadro" class="link_menu">Congregantes</a> | <a href="admin/index.php" target="cuadro" class="link_menu">Administración</a> | <a href="/mahanaim.tlalpan/" target="_self" class="link_menu">Salir</a></div>
      <div id="barra_ruta">:: Inicio ></div>
    </div>    
    <div id=contenido><iframe height="100%" width="100%" src="1.php" scrolling="auto" frameborder="0" id="cuadro"></iframe></div>
